                 ...
                 <div class="col">
                     <div class="course-item">
                         ...
                         <?php foreach ($kategori as $ktg) : ?>
                             <div onclick="window.location='<?= base_url('Buku/ByKategori/' . $ktg['nama_kategori']) ?>'" style=" cursor: pointer;" class="trainer d-flex justify-content-between align-items-center ">
                                 <div class="trainer-profile d-flex align-items-center">
