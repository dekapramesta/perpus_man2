<?php if ($this->session->flashdata('admin_buku')) {
    echo $this->session->flashdata('admin_buku');
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6 col-12">
                                                    ...
                                                    <input readonly type="text" name="isbn_code" class="form-control" value="<?= $buku->kode_buku ?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-6 col-12">
